...
def attack(char_name: str, char_class: str) -> str:
    """Сравнивает выбранную строку и возвращает.
    f-строку с рандомным значением.
    Нанесение урона.
    """
...
def defence(char_name: str, char_class: str) -> str:
    """Сравнивает строку и возвращает.
    f-строку с рандомным значением.
    Блокировка урона.
    """
    if char_class == 'warrior':
...
def special(char_name: str, char_class: str) -> str:
    """Сравнивает строку и возвращает.
    f-строку с значением.
    Применение специального умения урона.
    """
    if char_class == 'warrior':
...
def start_training(char_name: str, char_class: str) -> str:
    """Сравнивает строку и возвращает строку.
    Проверяет выбран ли skip.
    Проводит тренировку.
    """
    if char_class == 'warrior':
...
def choice_char_class() -> str:
    ...
    Ввод с клавиатуру значения, сравнивает
    и возвращает строку.
    """
